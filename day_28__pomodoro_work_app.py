...
tomato_label= Label(text="Timer", fg=GREEN, bg=YELLOW, font=((FONT_NAME, 35, "bold")))
tomato_label.grid(row=0, column=2)

start_button = Button(text="Start",command=start_timer)
start_button.grid(row=2, column=0)

end_button = Button(text="Reset",command=reset_timer)
end_button.grid(row=2, column=3)
